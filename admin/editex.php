...
<?php
	if(!isset($_GET['exid']) || $_GET['exid'] == NULL)
	{
		echo "<script>window.location = 'exlist.php'; </script>";
	}
	else
	{
		$exid = $_GET['exid'];
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <h3 class="h4">Update Slider Information</h3>
                    </div>
                    <div class="card-body">
...
<?php
	$query1 = "select * from tbl_exclusive where id='$exid'";
