        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Add Pricing Point</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
          <div class="breadcrumb-holder container-fluid">
            <ul class="breadcrumb">
			  ...
			  <li class="breadcrumb-item active">Add Pricing Point</li>
			</ul>
          </div>
          <!-- Forms Section-->
          <section class="forms"> 
...
<?php
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
        ...
        $query = "INSERT INTO tbl_pricing_point(type_1, type_2,type_3, title) VALUES('$type_1', '$type_2', '$type_3', '$title')";
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <span class="point-checkbox">
                                <input type="checkbox" name="type_1" value="1"> <span>Static</span> 
                            </span>
                            <span class="point-checkbox">
                                <input type="checkbox" name="type_2" value="1"> <span>Standard</span> 
                            </span>
                            <span class="point-checkbox">
                                <input type="checkbox" name="type_3" value="1"> <span>Premium</span>  
                            </span>
                          </div>
                        </div>
