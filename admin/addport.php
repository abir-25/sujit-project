		...
		else
		{
			if(!empty($file_name))
			{
				...
				{	
					...
					$query = "INSERT INTO tbl_portfolio(name, image, designation, speech) VALUES('$name', '$uploaded_image', '$designation', '$speech')";
...
?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
							<textarea name="speech" class="form-control" style="height:150px"></textarea>
                          </div>
                        </div>
