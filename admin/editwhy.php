...
<?php
	if(!isset($_GET['whyid']) || $_GET['whyid'] == NULL)
	{
              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="card">
                    ...
                    <h3 class="h4">Why Section Information</h3>
                    </div>
                    <div class="card-body">
...
<?php
	$query1 = "select * from tbl_why where id='$whyid'";
...
?>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <textarea name="description" id="" cols="30" rows="10" class="form-control"><?php echo $postresult['description']; ?></textarea>
                          </div>
                        </div>
