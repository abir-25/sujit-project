...
<?php
	...
	{
		echo "<script>window.location = 'blogtopiclist.php'; </script>";
	}
	else
	{
...
?>
<?php
	$query1 = "select * from tbl_category where id='$topicId'";
...
?>
                        <div class="form-group row">
                          <label class="col-sm-3 form-control-label">Category Title</label>
                          <div class="col-sm-9">
